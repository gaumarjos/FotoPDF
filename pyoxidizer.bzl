...
def make_exe(dist):
    ...
    # python_config.run_command = "import main.py; main.main_gui()"
    ...
    exe.add_python_resources(exe.read_package_root(
        path="/Users/ste/PycharmProjects/FotoPDF",
        packages=["main"],
    ))

    # Discover Python files from a virtualenv and add them to our embedded
    # context.
    exe.add_python_resources(exe.read_virtualenv(path="/Users/ste/PycharmProjects/FotoPDF/venv"))
